...
coluna2 = [
    ...
    'a revisão dos procedimentos atuais',
...
coluna3 = [
    ...
    'pode resultar em melhorias significativas',
...
coluna4 = [
    ...
    'e a adaptação às mudanças do mercado.',
]


def gerar_frase():
    return f'{random.choice(coluna1)} {random.choice(coluna2)} {random.choice(coluna3)} {random.choice(coluna4)}'
